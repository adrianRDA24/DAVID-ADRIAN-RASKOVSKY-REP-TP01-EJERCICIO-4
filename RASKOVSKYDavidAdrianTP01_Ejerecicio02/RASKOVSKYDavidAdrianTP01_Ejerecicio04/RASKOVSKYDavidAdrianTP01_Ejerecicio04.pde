...
puntoMedio =new PVector(width/2,height/2); // para el circulo del medio rojo
//puntoA1=new PVector(width/4,height/4); 
puntoA1=new PVector((width/5),(height/2)); // para el circulo amarillo izq
puntoB3=new PVector((width - 75),(height/2));  // para el circulo amarillo derecho
...
color c1 = color(250, 17, 10); // color LINEA negro
        ...
        line(puntoB1.x, puntoB1.y,puntoB2.x, puntoB2.y);   // linea AZUL
